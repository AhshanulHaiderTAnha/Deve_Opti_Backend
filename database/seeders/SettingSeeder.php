...
class SettingSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $settings = [
            // General
            ['key' => 'system_name', 'value' => 'Stockrevive', 'group' => 'general', 'type' => 'string'],
            ...
            // SEO
            ['key' => 'meta_title', 'value' => 'Stockrevive - Next Gen Logistics', 'group' => 'seo', 'type' => 'string'],
            ...
            // Email
            ['key' => 'mail_from_name', 'value' => 'Stockrevive Support', 'group' => 'email', 'type' => 'string'],
