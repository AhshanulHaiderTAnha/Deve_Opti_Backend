...
export default function Create() {
    ...
    return (
        <AdminLayout>
            <Head title="Post New Announcement" />

            <div className="max-w-4xl mx-auto space-y-6">
                <div className="flex items-center justify-between">
                    <div>
                        <h1 className="text-2xl font-black tracking-tight text-gray-900">Post New News</h1>
                        <p className="text-gray-500 font-medium">Broadcast updates and notices to all platform users.</p>
                    </div>
                    <Link
                ...
                <div className="bg-white rounded-[2.5rem] border border-gray-100 shadow-xl overflow-hidden">
                    <form onSubmit={submit} className="p-10 space-y-8">
                        ...
                        <div className="space-y-3">
                            ...
                            <input
                                type="text"
                                className="w-full px-6 py-4 bg-gray-50 border-none rounded-2xl focus:ring-2 focus:ring-orange-500/20 font-bold placeholder:text-gray-300 transition-all"
                                value={data.title}
                        ...
                        <div className="flex items-center space-x-3 p-6 bg-orange-50/50 rounded-3xl border border-orange-100/50">
                            ...
                            />
                            <label htmlFor="is_pinned" className="text-xs font-black text-gray-600 cursor-pointer uppercase tracking-widest">Pin this announcement to the top of user dashboard</label>
                        </div>
